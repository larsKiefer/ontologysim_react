...
import KPIMachineSumTable from "../table/kpi/KPIMachineSumTable";
import KPIMachineTimeTable from "../table/kpi/KPIMachineTimeTable";
...
const importantKPIData = [
  {
    name: "OEE",
    type: "Basic",
    toolbar: "Overall equipment effectiveness in %",
    unit: "percentage",
  },
  {
    name: "AUPTp",
    type: "Basic",
    toolbar: "Actual unit processing time in %",
    unit: "percentage",
  },
  {
    name: "AUITp",
...
/**
 * element which handles machine kpi data
 * @returns
 */
function MachineKPI() {
  ...
  for (const [key, value] of Object.entries(kpiState.machine["summarized"])) {
    var objectKPI = {};
  ...
  const timeList = React.useMemo(() => kpiState.machine["time"].time);
      ...
      return (
        <div className="row pl-2 pr-2 pt-1 pb-2 bg-light">
          <div className="col-12 pb-0 pl-1 pr-1 ">
            <KPIMachineSumTable data={summarizedTableList}></KPIMachineSumTable>
          </div>
        </div>
      );
    } else {
      ...
      return (
        <div className="row pt-1 pb-2">
          <div className="col-12 pb-0  ">
            <KPIMachineTimeTable data={timeTableList}></KPIMachineTimeTable>
          </div>
        </div>
      );
    }
