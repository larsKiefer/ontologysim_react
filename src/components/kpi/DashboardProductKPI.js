...
/**
 * summary kpi for product with pie chart and time diagramm
 * @param {*} props 
 * @returns 
 */
function DashboardProductKPI(props){
        ...
        <Card className="">
            <Card.Body className="pl-2 pr-2 pt-2 ">
              <div className="d-flex align-items-end ">
                ...
                <h6 className="text-muted mb-0 ml-2">AOET: {props.AOET}</h6>
                <p
...
export default DashboardProductKPI